	...
	public void Setupboots()
	{
		...
		vertices = new float[]
		           {//XXX   YYYY  ZZZZ
					...
					//^ body
					130.0f, 160.0f, 0.0f, //15
					300.0f, 160.0f, 0.0f, //16
					130.0f, 175.0f, 0.0f,//17
					300.0f, 175.0f, 0.0f,//18
					//^arrrm
					300.0f, 300.0f, 0.0f,//19
					270.0f, 167.5f, 0.0f,//20
					300.0f, 34.0f, 0.0f,//21
					//^bow
					//back
					350.0f, 175.0f, 0.0f,//22
					350.0f, 165.0f, 0.0f,//23
					355.0f, 170.0f, 0.0f,//24
					//stick
					350.0f, 171.0f, 0.0f,//25
					350.0f, 169.0f, 0,0f,//26
					380.0f, 171.0f, 0.0f,//27
					380.0f, 169.0f, 0.0f,//28
					//front
					380.0f, 175.0f, 0.0f,//29
					380.0f, 165.0f, 0.0f,//30
					395.0f, 170.0f, 0.0f//31
					//ARROW
		           };
